...
import guru.qa.config.PersonalCredentialsConfig;
...
public class PersonalMobileDriver implements WebDriverProvider {
    static PersonalCredentialsConfig credentialsConfig = ConfigFactory.create(PersonalCredentialsConfig.class);
